...
def upgrade() -> None:
    op.execute(
        ...
        CREATE INDEX idx_free_today_items_sort ON free_today_items (sort_order);
        """
    )
    ...
    op.execute("GRANT SELECT, INSERT, UPDATE, DELETE ON free_today_items TO service_role")
