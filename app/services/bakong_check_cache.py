...
# NBC daily check quota is ~100/token. Keep unpaid TTL short so active
# checkout (~3s polls) can see a payment within a few seconds of pay.
_UNPAID_TTL_SECONDS = 5.0
